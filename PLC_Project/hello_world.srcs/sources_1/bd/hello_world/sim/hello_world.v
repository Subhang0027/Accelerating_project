...
//Date        : Mon Dec 26 16:34:51 2022
//Host        : SubhangPC running 64-bit major release  (build 9200)
//Command     : generate_target hello_world.bd
//Design      : hello_world
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "hello_world,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=hello_world,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "hello_world.hwdef" *) 
module hello_world
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  hello_world_processing_system7_0_0 processing_system7_0
