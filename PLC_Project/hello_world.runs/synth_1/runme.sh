...
HD_PWD='C:/Users/attit/OneDrive/Desktop/hello_world/hello_world.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_world_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_world_wrapper.tcl
