...
HD_PWD='C:/Users/attit/OneDrive/Desktop/hello_world/hello_world.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_world_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hello_world_wrapper.tcl -notrace
