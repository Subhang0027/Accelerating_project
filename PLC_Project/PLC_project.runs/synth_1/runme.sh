...
HD_PWD='D:/Masters/APLC/Project/PLC_project/PLC_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PLC_project_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PLC_project_wrapper.tcl
