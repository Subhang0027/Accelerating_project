...
HD_PWD='D:/Masters/APLC/Project/PLC_project/PLC_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PLC_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PLC_project_wrapper.tcl -notrace
