...
HD_PWD='D:/Masters/APLC/Project/PLC_project/PLC_project.runs/PLC_project_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PLC_project_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PLC_project_processing_system7_0_0.tcl
