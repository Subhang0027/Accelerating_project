...
//Date        : Thu Dec 29 18:05:24 2022
//Host        : SubhangPC running 64-bit major release  (build 9200)
//Command     : generate_target PLC_project.bd
//Design      : PLC_project
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PLC_project,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PLC_project,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "PLC_project.hwdef" *) 
module PLC_project
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  PLC_project_processing_system7_0_0 processing_system7_0
